...
In addition, the model includes department-level cost analysis and a debtors aging view to provide insight into working capital management and cost distribution across business units.

##Tools & Approach:
The dashboard was developed in Microsoft Excel using a Budget vs Actual framework. Variance analysis was applied to measure performance gaps, and data from multiple sheets was consolidated into a single reporting view for management review.

## Practical Application:
This dashboard reflects how monthly financial performance is typically reviewed in an FP&A setting. It brings together revenue, cost, and profitability metrics in one place, making it easier to identify where the business is performing as planned and where corrective action may be required.
By tracking budget variances, department-level costs, EBIT movement, and debtor trends, the model supports structured performance discussions and helps highlight areas that may require tighter cost control or operational focus.
